class AlertsContainer{constructor({type:t,position:e,darkMode:r,animation:s,wallGap:_,fontSize:o,colors:a}){let l={standard:{textColor:{dark:"#FFFFFF",light:"#000000"},bgColor:{dark:"#303030",light:"#FFFFFF"},error:"#d64747",warning:"#d27722",success:"#0ba808",alert:"#5274ca"},colorfull:{textColor:{dark:"#FFFFFF",light:"#000000"},bgColor:{dark:"#303030",light:"#FFFFFF"},error:"#d64747",warning:"#d27722",success:"#0ba808",alert:"#5274ca"},glass:{textColor:{dark:"#FFFFFF",light:"#000000"},bgColor:{dark:"linear-gradient(91.45deg, #0000001a 0%, #0000000d 100%)",light:"linear-gradient(91.45deg, #fafafa38 0%, #fafafa1c 100%)"},error:"#d64747",warning:"#d27722",success:"#0ba808",alert:"#5274ca"}};this.type=t||"standard",this.fallbackValues={type:this.type,position:e||"bottom-left",darkMode:r||!1,animation:s?{type:s.type||"slide-right",duration:s.duration||300,easing:s.easing||"ease"}:{type:"slide-right",duration:300,easing:"ease"},wallGap:_||10,fontSize:o||24,colors:a?{textColor:a.textColor?{dark:a.textColor.dark||l[this.type].textColor.dark,light:a.textColor.light||l[this.type].textColor.light}:l[this.type].textColor,bgColor:a.bgColor?{dark:a.bgColor.dark||l[this.type].bgColor.dark,light:a.bgColor.light||l[this.type].bgColor.light}:l[this.type].bgColor,error:a.error||l[this.type].error,warning:a.warning||l[this.type].warning,success:a.success||l[this.type].success,alert:a.alert||l[this.type].alert}:l[this.type]};let i=document.createElement("div");i.setAttribute("id","alerts-container"),i.classList.add(this.fallbackValues.position),i.classList.add(this.fallbackValues.animation.type),i.classList.add(this.fallbackValues.type),this.fallbackValues.darkMode&&i.classList.add("dark"),i.style.setProperty("--error-color",this.fallbackValues.colors.error),i.style.setProperty("--warning-color",this.fallbackValues.colors.warning),i.style.setProperty("--success-color",this.fallbackValues.colors.success),i.style.setProperty("--alert-color",this.fallbackValues.colors.alert),i.style.setProperty("--light-bg-color",this.fallbackValues.colors.bgColor.light),i.style.setProperty("--dark-bg-color",this.fallbackValues.colors.bgColor.dark),i.style.setProperty("--light-text-color",this.fallbackValues.colors.textColor.light),i.style.setProperty("--dark-text-color",this.fallbackValues.colors.textColor.dark),i.style.setProperty("--wall-gap",this.fallbackValues.wallGap.toString()+"px"),i.style.setProperty("--fonts-size",this.fallbackValues.fontSize.toString()+"px"),i.style.setProperty("--animation-duration",this.fallbackValues.animation.duration.toString()+"ms"),i.style.setProperty("--animation-easing",this.fallbackValues.animation.easing),document.body.appendChild(i)}createAlert(t,e="alert",r=3e3){let s=document.querySelector("#alerts-container"),_=this.fallbackValues.animation,o={error:`<svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            `};function a(t,e){if(void 0===o[e]){console.error("Type argument (parameter 2 of the createalert() function) is of an unaccepted value.");return}var r=document.createElement("div");r.classList.add("alerts"),r.classList.add(`${e}`);var s=document.createElement("div");s.classList.add("alerts-icon"),s.classList.add(`${e}`),s.innerHTML=o[e],r.appendChild(s);var _=document.createElement("p");return _.classList.add("alerts-text"),_.innerText=t,r.appendChild(_),r}if("persisted"===r){var l,i,$,n;l=t,i=e,$=a(l,i),(n=document.createElement("div")).classList.add("alerts-close-icon"),n.innerHTML=o.close,$.appendChild(n),s.appendChild($),setTimeout(()=>{$.classList.add("show")},10),n.addEventListener("click",()=>{$.classList.remove("show"),setTimeout(()=>{$.remove()},_.duration)})}else if("number"==typeof r){var d=a(t,e);s.appendChild(d),setTimeout(()=>{d.classList.add("show")},10),setTimeout(()=>{d.classList.remove("show"),setTimeout(()=>{d.remove()},_.duration)},r)}else console.error('Duration argument (parameter 3 of the createAlert() function) is of an unaccepted value. It should be a Number > or = 0 or a string of the value "persisted" for persisted notifications')}}