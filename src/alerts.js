class AlertsContainer {
    constructor({ position, darkMode, stacking, wallGap, colors, corners, hideCountdown }) {
        ...
        this.colorScheme = colors
            ? {
                  text: colors.text
                      ? { dark: colors.text.dark || defaultColorScheme.text.dark, light: colors.text.light || defaultColorScheme.text.light }
                      : defaultColorScheme.text,
                  background: colors.background
                      ? {
                            dark: colors.background.dark || defaultColorScheme.background.dark,
                            light: colors.background.light || defaultColorScheme.background.light,
                        }
                      : defaultColorScheme.background,
                  error: colors.error
                      ? { dark: colors.error.dark || defaultColorScheme.error.light, light: colors.error.light || defaultColorScheme.error.light }
                      : defaultColorScheme.error,
                  warning: colors.warning
                      ? {
                            dark: colors.warning.dark || defaultColorScheme.warning.light,
                            light: colors.warning.light || defaultColorScheme.warning.light,
                        }
                      : defaultColorScheme.warning,
                  success: colors.success
                      ? {
                            dark: colors.success.dark || defaultColorScheme.success.light,
                            light: colors.success.light || defaultColorScheme.success.light,
                        }
                      : defaultColorScheme.success,
                  alert: colors.alert
                      ? { dark: colors.alert.dark || defaultColorScheme.alert.light, light: colors.alert.light || defaultColorScheme.alert.light }
                      : defaultColorScheme.alert,
              }
            : defaultColorScheme;
        ...
        if (this.corners === "round") {
            alertContainer.style.setProperty("--radius", "999px");
        ...
        alertContainer.style.setProperty("--bg-light", this.colorScheme.background.light);
        alertContainer.style.setProperty("--bg-dark", this.colorScheme.background.dark);
        alertContainer.style.setProperty("--error-light", this.colorScheme.error.light);
        alertContainer.style.setProperty("--error-dark", this.colorScheme.error.dark);
        alertContainer.style.setProperty("--warning-light", this.colorScheme.warning.light);
        alertContainer.style.setProperty("--warning-dark", this.colorScheme.warning.dark);
        alertContainer.style.setProperty("--success-light", this.colorScheme.success.light);
        alertContainer.style.setProperty("--success-dark", this.colorScheme.success.dark);
        ...
        function moveItemsStack(val) {
            ...
            for (let i = 0; i in this.alertsArray; i++) {
                if (i < 4) {
                    ...
                    this.alertsArray[this.alertsArray.length - 1 - i].style.scale = `${1 - i / 20}`;
                }
            }
        }
